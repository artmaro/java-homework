...
public class CrunchifyRESTJerseyClient {
    ...
    private void getFtoCResponse() {
        try {
            ...
            WebResource webResource2 = client.resource("http://localhost:8080/crunchify/ftocservice/90");
    ...
    private void getCtoFResponse() {
        try {
            ...
            Client client = Client.create();
            WebResource webResource = client.resource("http://localhost:8080/crunchify/ctofservice/40");
